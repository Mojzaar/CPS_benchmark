function [N, A, exTimeAverage, totalTime] = HPSTL(in, b_u,dSingnificanceLevel,delta)
% Inputs:
%       in:                     Simulink function handle,
...
cnt = 0;
s = [];
delta = 10/6 * delta; % map distance threshold to time threshold
